...
function Home() {
    ...
    const transcribingService = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$TranscribingService$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TranscribingService"](), []);
    const captureScreenshot = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (!videoRef.current || !canvasRef.current) return;
        transcribingService.captureScreenshot(videoRef.current, canvasRef.current);
    }, [
        transcribingService
    ]);
    const startRecording = async ()=>{
        ...
        try {
            await transcribingService.startRecording(videoRef.current, captureScreenshot);
            setIsRecording(true);
            setResult(null);
            setActiveTab("score");
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f1fdb4b0._.js.map